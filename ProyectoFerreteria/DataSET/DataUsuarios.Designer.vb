...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class UsuariosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Usuario], [Clave]) VALUES (@Usuario, @Clave);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SEL"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuarios] SET [Usuario] = @Usuario, [Clave] = @Clave WHERE (([ID] ="& _ 
                " @Original_ID) AND ((@IsNull_Usuario = 1 AND [Usuario] IS NULL) OR ([Usuario] = "& _ 
                "@Original_Usuario)) AND ((@IsNull_Clave = 1 AND [Clave] IS NULL) OR ([Clave] = @"& _ 
                "Original_Clave)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Usuario, Clave FROM Usuarios WHERE (ID = @ID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ProyectoFerreteria.My.MySettings.Default.FerreteriaBDDConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Usuario, Clave FROM dbo.Usuarios"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Usuario As String, ByVal Original_Clave As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Usuario As String, ByVal Clave As String, ByVal Original_ID As Integer, ByVal Original_Usuario As String, ByVal Original_Clave As String, ByVal ID As Integer) As Integer
            If (Usuario Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Usuario As String, ByVal Clave As String, ByVal Original_ID As Integer, ByVal Original_Usuario As String, ByVal Original_Clave As String) As Integer
            Return Me.Update(Usuario, Clave, Original_ID, Original_Usuario, Original_Clave, Original_ID)
        End Function
    End Class
